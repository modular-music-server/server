...
func HandleProviderEntries(providerEntries []*ProviderEntry) ([]*Provider, error) {
    var providers []*Provider;
    for _, providerEntry := range providerEntries {
        provider, err := handleProviderEntry(providerEntry)
        if err != nil {
            return nil, err
        }
...
func handleProviderEntry(providerEntry *ProviderEntry) (*Provider, error) {
